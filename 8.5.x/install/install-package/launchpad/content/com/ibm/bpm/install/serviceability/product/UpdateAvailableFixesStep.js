...
dojo.provide("com.ibm.bpm.install.serviceability.product.UpdateAvailableFixesStep");
dojo.require("com.ibm.bpm.install.utils.InstallUtils");

/*
 * Get available fixes
 */
dojo.declare("com.ibm.bpm.install.serviceability.product.UpdateAvailableFixesStep", null, {
    ...
    execute: function(){
        ...
        result = com.ibm.bpm.install.utils.InstallUtils.getAvailableFixes("test", this.keyRingLocation, this.logName, this.id, this.repository);
