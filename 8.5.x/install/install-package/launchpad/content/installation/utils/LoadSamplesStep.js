...
dojo.provide("installation.utils.LoadSamplesStep");
...
dojo.declare("installation.utils.LoadSamplesStep", [installation.utils.InstallStep], {
    ...
    execute: function(data){
        ...
        this.loadSamplesFilename = installation.utils.InstallUtils.getPersistedTempFilename("loadSamples");
	...
	//washome_unix.replace(/\\/g, "/");
        ...
        installation.utils.InstallUtils.loadSamples(loadSamplesCommand, options, this.loadSamplesFilename);
    },
    ...
    getResult: function(){
        ...
        if (!this.success) {
            var filename = installation.utils.InstallUtils.getCanonicalFilename(this.loadSamplesFilename);
