...
dojo.provide("installation.utils.UpdateAvailableFixPacksStep");
 ...
 */
 ...
 dojo.declare("installation.utils.UpdateAvailableFixPacksStep", null, {
    ...
    execute: function(){
    	...
    	logger.logMessage("I: At the begninning of AvailableFixPacksStep");
			...
			var  result =  installation.utils.InstallUtils.getAvailableFixPacks("test",this.keyRingLocation,
			this.repositories,this.logName);
